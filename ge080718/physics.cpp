...
bool Physics::overlaps(const Collider& box1, const Collider& box2) const
{
	return 
...
Collision Physics::collision(const Collider& box1, const Vec2& vel, const Collider& box2) const
{
	Rect xBox = {
		box1.x1 + vel.x,
		box1.y1,
